...
const TambahBioskop = () => {
    ...
    if (!form.alamat.trim()) newErrors.deskripsi = 'alamat harus diisi';
    if (!form.tlp.trim()) newErrors.genre = 'telepon harus diisi';
    ...
    <div className={styles.container}>
        ...
        <div className={styles.formGroup}>
            <label htmlFor="Telepon">Telopon</label>
            <input
            id="telepon"
            type="text"
            value={form.genre}
            ...
            />
          {errors.telepon && <p className={styles.errorText}>{errors.telepon}</p>}
        </div>
